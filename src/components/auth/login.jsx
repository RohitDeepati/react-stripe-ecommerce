    ...
    <div className="max-w-md mx-auto mt-10 p-4 bg-[whitesmoke] rounded-lg shadow-lg border border-gray-300">
      ...
      <form onSubmit={submitHandler} className="flex flex-col">
        ...
        <div className="flex flex-col  gap-2 p-1 " >
          <label>Email</label>
          <input placeholder="Enter Your email" name="email" ref={emailInputRef} value={enteredEmail} onChange={(e) => setEnteredEmail(e.target.value)} type="email" className={`border border-gray-300 text-sm focus:outline-none  p-2 rounded ${error === "invalid email or password" ? "border-red-500" : "border-gray-300"}`} />
        ...
        <div className="flex flex-col justify-center gap-2 p-1">
          ...
          <input placeholder="Enter Your Password" ref={passwordInputRef} name="password" value={enteredPassword} onChange={(e) => setEnteredPassword(e.target.value)} type="password" className={`border border-gray-300 text-sm focus:outline-none  p-2 rounded ${error === "invalid email or password" ? "border-red-500" : "border-gray-300"}`} />
